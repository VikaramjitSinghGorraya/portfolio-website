...
const Navbar = () => {
    ...
    return (
        <HStack spacing = {5} minH = '100'>
            <MotionLink background= 'linear-gradient(green, green) bottom/0% 2px no-repeat' initial = {{backgroundSize:'none'}} animate ={history.location.pathname === '/'? { backgroundSize: '100% 2px'}:''} transition = {{duration:0.25}} href = '/' fontWeight = "extrabold" fontSize = "20">Vikaramjit Singh</MotionLink>
